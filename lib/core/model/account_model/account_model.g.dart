...
AccountModel _accountModelDeserialize(
  ...
  object.amountAvailable = reader.readDouble(offsets[2]);
...
extension AccountModelQueryFilter
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterFilterCondition>
  amountAvailableEqualTo(double value, {double epsilon = Query.epsilon}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'amountAvailable',
          value: value,
...
extension AccountModelQuerySortBy
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy>
  sortByAmountAvailable() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'amountAvailable', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy>
  sortByAmountAvailableDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'amountAvailable', Sort.desc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByDateCreated() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByDateModified() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountModelQuerySortThenBy
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy>
  thenByAmountAvailableDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'amountAvailable', Sort.desc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByDateCreated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateCreated', Sort.asc);
    });
  }
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByDateModified() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateModified', Sort.asc);
    });
  }
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }
...
extension AccountModelQueryWhereDistinct
  ...
  distinctByAmountAvailable() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'amountAvailable');
    });
  }

  QueryBuilder<AccountModel, AccountModel, QDistinct> distinctByDateCreated() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dateCreated');
    });
  }

  QueryBuilder<AccountModel, AccountModel, QDistinct> distinctByDateModified() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dateModified');
    });
  }

  QueryBuilder<AccountModel, AccountModel, QDistinct> distinctByDescription({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension AccountModelQueryProperty
  ...
  amountAvailableProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'amountAvailable');
    });
  }

  QueryBuilder<AccountModel, DateTime, QQueryOperations> dateCreatedProperty() {
    return QueryBuilder.apply(this, (query) {
